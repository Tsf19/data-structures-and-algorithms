...
public class _1_TwoSum_2_SolutionDriverClass {
	...
	public static void main(String[] args) {
    	...
    	testTwoSum(new _1_TwoSum_3_MyInitialSolution());

		/** A more efficient approach is to use a hash table.*/
		// Using a Hash Table : Time Complexity: O(n) | Space Complexity: O(n)
		testTwoSum(new _1_TwoSum_4_OtherSolution());

		/** One-pass Hash Table */
		testTwoSum(new _1_TwoSum_5_OtherSolutionUpdated());
	}

	static void testTwoSum(_1_TwoSum_1_Problem solution) {
