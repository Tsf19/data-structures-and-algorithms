...
public class _01347_MinimumStepsToAnagram_2_SolutionDriverClass {

    public static void main(String[] args) {
    	
    	_01347_MinimumStepsToAnagram_1_Problem solution = new _01347_MinimumStepsToAnagram_3_MyInitialSolution_HashMap();
