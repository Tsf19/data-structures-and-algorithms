...
public class TestDeadlock {
	...
	public static void main(String[] args) {
		...
		System.out.println("creating one object");
		Shared s1 = new Shared();
		Shared s2 = new Shared();
		
		System.out.println("creating first thread and starting it");
		Thread1 t1 = new Thread1(s1, s2);
		t1.setName("Thread1");
		t1.start();
		
		System.out.println("creating second thread and starting it");
